return {
	...
	config = function()
        ...
        keymap.set("n", "<leader>fd", "<cmd>Telescope lsp_document_symbols<CR>", {desc = "Find document symbols in buffer"})
        keymap.set("n", "<leader>fb", "<cmd>Telescope buffers<CR>", {desc = "Show all opened buffers"})
